...
- 🧪 **Query**: `db.restaurants.find({$and:[{"cuisine":{$nin:["American"]}},{"grades":{$elemMatch:{"score":{$gt:70}}}},{"location.coordinates.0":{$lt:-65.754168}}]})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: COLLSCAN
...
- 🧪 **Query**: `db.restaurants.find({"cuisine":{ $nin:["American"]},"grades":{$elemMatch:{"score":{$gt:70}}},"location.coordinates.0":{$lt:-65.754168}})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: COLLSCAN
...
- 🧪 **Query**: `db.restaurants.find({"cuisine":{$nin : ["American"]},"grades":{$elemMatch:{"grade":"A"}},"borough":{$nin:["Brooklyn"]}},{_id:0}).sort({"cuisine":-1})`
...
- 🧪 **Query**: `db.restaurants.find({"grades":{"grades.1.grade":"A","grades.1.score":9,"date":ISODate("2014-08-11T00:00:00Z")}},{_id:0,restaurant_id:1,name:1,grades:1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 0
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({$or:[{"location.coordinates.0":{$type:"double"}},{"location.coordinates.1":{$type:"double"}}]},{_id:0,restaurant_id:1,name:1,"location.coordinates":1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: SUBPLAN
...
- 🧪 **Query**: `db.restaurants.find({"grades":{$elemMatch:{"score":{$mod:[7,0]}}}},{_id:0,name:1,"grades.grade":1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({name:{$regex:"mon",$options:"i"}},{_id:0,name:1,borough:1,"location.coordinates":1})`
- ⏱️ **Execution time**: 1 ms
...
- 🧪 **Query**: `db.restaurants.find({"grades":{$elemMatch:{"score":{$gt:80,$lt:100}}}},{restaurant_id:1,name:1,"grades.grade":1,"grades.score":1,_id:0})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 1
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_DEFAULT

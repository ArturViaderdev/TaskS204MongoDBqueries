...
db.restaurants.find({"grades.score":{$lt:10}},{_id:1,name:1,borough:1});
...
db.restaurants.find({"grades":{$elemMatch:{"grade":"A","score":11,"date":ISODate("2014-08-11T00:00:00Z")}}}); // revisar
